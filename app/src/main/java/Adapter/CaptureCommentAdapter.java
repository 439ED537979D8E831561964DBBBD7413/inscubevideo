...
public class CaptureCommentAdapter extends RecyclerView.Adapter<CaptureCommentAdapter.ViewHolder> {
    ...
    CaptureCommentAdapter a;

    public void setA(CaptureCommentAdapter a) {
        this.a = a;
    }

    public CaptureCommentAdapter(Context context, List<Comment_List> list, RecyclerView rv) {
        this.list = list;
    ...
    @NonNull
    @Override
    public CaptureCommentAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new CaptureCommentAdapter.ViewHolder(v);
    }

    @Override

    public void onBindViewHolder(@NonNull final CaptureCommentAdapter.ViewHolder holder, final int position) {
            ...
            public void onClick(View v) {
                        ...
                        comment_update.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                if (comment_edit_input.getText().toString().isEmpty()) {
                                    ...
                                    String u = Config.BASE_URL + "Capture/Capture_Comment_Update";
                    ...
                    public void onClick(View v) {
                        ...
                        yes.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                String u = Config.BASE_URL + "Capture/Capture_Comment_Delete/" + list.get(position).getComment_Id();
                ...
                reportpost.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        String u = Config.BASE_URL + "Capture/Report_CaptureComment_Check";
                                    ...
                                    if (json.getString("Available").contains("True")) {
                                        ...
                                        report_post_submit.setOnClickListener(new View.OnClickListener() {
                                            ...
                                            public void onClick(View v) {
                                                ...
                                                String u = Config.BASE_URL + "Capture/Report_CaptureComment";
                ...
                reportuser.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        String u = Config.BASE_URL + "Capture/Capture_Report_User_Check";
                                    ...
                                    if (json.getString("Available").contains("True")) {
                                        ...
                                        report_user_submit.setOnClickListener(new View.OnClickListener() {
                                            ...
                                            public void onClick(View v) {
                                                ...
                                                String u = Config.BASE_URL + "Capture/Capture_Report_User";
