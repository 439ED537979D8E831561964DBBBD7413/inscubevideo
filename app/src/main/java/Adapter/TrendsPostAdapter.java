...
import com.test.aashi.inscubenewbuild.Trends_Comments;
...
public class TrendsPostAdapter extends RecyclerView.Adapter<TrendsPostAdapter.ViewHolder>
{
   ...
   String post_id;
    ...
    public void setA(TrendsPostAdapter a) {
        this.a = a;
    }

    public TrendsPostAdapter(Context context, List<Highlights_PostList> list) {
        this.list = list;
    ...
    public void onBindViewHolder(@NonNull final ViewHolder holder, final int position) {
        ...
        {
            holder.shared.setText(" shared his own Trend");
        }
        else
        {
            if (list.get(position).getOwnername().length() >12)
            {
                holder.shared.setText(" shared "+ list.get(position).getOwnername().substring(0,12)+"..." + " Trend");
            }
            else
            {
            holder.shared.setText(" shared "+ list.get(position).getOwnername()+ "'s Trend");
            }
        }
      ...
      /*  trends = new ArrayList<>();
        String trend[]=list.get(position).getTags().split("[ ]+");
        trends.addAll(Arrays.asList(trend));
        */
      if (list.get(position).getTrends_text().size() != 0)
      {
          holder.trendTextAdatper=new TrendTextAdatper(context,list.get(position).getTrends_text(),holder.trends_view,position);
          holder.trends_view.setAdapter(holder.trendTextAdatper);
          holder.trends_view.setVisibility(View.VISIBLE);
      }
       grid_elements=new ArrayList<>();
        if (list.get(position).getCube_name().size() != 0) {

            holder.smallIcon_adapter = new FeedAdapterSmallIcon(context, list.get(position).getCube_Id(), list.get(position).getCube_Cat_Id(), list.get(position).getCube_name(),
        ...
        /*         holder.multi_img_rv.setVisibility(View.GONE);
            holder.imageAdapter =new ImageAdapter(context,list.get(position).getFile_Name(),holder.image_view,holder.imageAdapter,
                    1);
            holder.imageAdapter.setAdapter(holder.imageAdapter);

*/


       holder.multi_image_adapter = new Post_MultiImage_Adapter
                    (context, list.get(position).getFile_Name(), holder.multi_img_rv,
        ...
        if (list!=null && list.get(position).getEmoteLists()!=null &&  list.get(position).getEmoteLists().size() != 0) {
                    ...
                    public void onClick(View v) {
                        ...
                        yes.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                String u = Config.BASE_URL + "Trends/Cube_Trends_Delete/" + list.get(position).getPost_Id();
...
*/
                ...
                reportpost.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        String u = Config.BASE_URL + "Trends/Report_Trends_Check";
                                    ...
                                    if (json.getString("Available").contains("True")) {
                                        ...
                                        report_post_submit.setOnClickListener(new View.OnClickListener() {
                                            ...
                                            public void onClick(View v) {
                                                ...
                                                String u = Config.BASE_URL + "Trends/Report_Trends";
                        ...
                        if (emote_input.getText().toString().isEmpty()) {
                            ...
                            StringRequest MyStringRequest = new StringRequest(Request.Method.POST, u, new Response.Listener<String>() {
                                ...
                                protected Map<String, String> getParams() {
                                    ...
                                    para.put("Trends_Id", list.get(position).getPost_Id());
                                    para.put("User_Id", login_user_id);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        TextView lines, Story_user_name, post_type, time_agotxt, view_all, post_text, any_link, link_des, link_url, link_title, tags;
        ...
        GridView emote_view,image_view,trends_view;
        FeedAdapterSmallIcon smallIcon_adapter;
        TrendTextAdatper trendTextAdatper;
        ...
        public ViewHolder(View itemView) {
           ...
           lines=(TextView)itemView.findViewById(R.id.lines);
            text=(TextView)itemView.findViewById(R.id.tags_texts);
            ...
            trends_view=(GridView) itemView.findViewById(R.id.trendsview);
            ...
            image_view=(GridView)itemView.findViewById(R.id.images);
    ...
    public class TrendTextAdatper extends BaseAdapter {
        Context context;
        ArrayList<String> treds_text;
        GridView gridView;
        int positions;


        public TrendTextAdatper(Context context, ArrayList<String> trendslist,GridView gridView,int positions) {
            this.treds_text = trendslist;
            this.context = context;
        ...
        public View getView(final int n, View convertView, ViewGroup parent) {
            ...
            if (rowView == null) {
                ...
                rowView = inflater.inflate(R.layout.text_view, parent, false);
                viewHolders = new Viewholder();
                viewHolders.textView = (TextView) rowView.findViewById(R.id.trendstext);
                if(context instanceof StoryPage){
                  viewHolders.tableLayout =   ((StoryPage) context).findViewById(R.id.tab_layout);
                }

                rowView.setTag(viewHolders);

            } else {

                viewHolders = (Viewholder) rowView.getTag();
            }

            if(list.get(positions).getTrends_text().get(n).length() < 11)
            {
                viewHolders.textView.setText(list.get(positions).getTrends_text().get(n));
            }
            else
            {
                viewHolders.textView.setText(list.get(positions).getTrends_text().get(n).subSequence(1,11)+"..");
            }


            viewHolders.textView.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v)
                {
                    Bundle bundle=new Bundle();
                    bundle.putString("my_tags",list.get(positions).getTrends_text().get(n).trim());
                    bundle.putString("forview","0");
                    viewHolders.tableLayout.setVisibility(View.GONE);
...
//                    .placeholder(R.drawable.loading_spinner)
    ...
    private class SharePost extends AsyncTask {
        ...
        protected Object doInBackground(Object[] objects)
        {
            ...
            String u = Config.BASE_URL + "Trends/Cube_Trends_Share";
                    ...
                    public void onClick(View v) {
                        ...
                        StringRequest MyStringRequest = new StringRequest(Request.Method.POST, u, new Response.Listener<String>() {
                            ...
                            public void onResponse(String response)
                            {
                                try {
                                    ...
                                    if (json.getString("Output").contains("True"))
                                    {
                                        ...
                                        viewHolder.emote_layout.setBackground(context.getResources().getDrawable(R.drawable.emote_outline_design_selected));
                                        viewHolder.emote_layout.setEnabled(false);
                                        list.get(viewPosition).getEmoteLists().get(i).setEmote_Count(data.getString("Count"));
                                        TrendsPostAdapter.this.notifyDataSetChanged();
                                    }
                                } catch (JSONException e) {
                                    e.printStackTrace();
                                }
                            ...
                            protected Map<String, String> getParams() {
                                ...
                                para.put("Trends_Id", list.get(viewPosition).getEmoteLists().get(i).getEmote_post_Id());
                                para.put("User_Id", login_user_id);
...
//            viewHolder.emote_layout.setOnLongClickListener(new View.OnLongClickListener() {
//                @Override
...
//                    int[] location = new int[2];
//
//                    viewHolder.emote_layout.getLocationOnScreen(location);
//
//                    p = new Point();
//                    p.x = location[0];
//                    p.y = location[1];
//
//                   // View layout = viewHolder.layoutInflater.inflate(R.layout.edit_popup, viewHolder.layoutInflater);
//
//                    View layout = viewHolder.layoutInflater.inflate(R.layout.edit_popup,viewHolder.lay);
//
//                    // Creating the PopupWindow
//                    final PopupWindow popup = new PopupWindow(context);
//                    popup.setContentView(layout);
...
//
//
//                    if (emote_id_listt.get(i).equals(login_user_id)) {
//
//                        reportview.setVisibility(View.GONE);
//                        editview.setVisibility(View.VISIBLE);
//
...
//                                    RequestQueue MyRequestQueue = Volley.newRequestQueue(context);
//
//                                    String u = Config.BASE_URL + "Posts/Cube_post_Delete/" + list.get(i).getPost_Id();
//
//                                    StringRequest MyStringRequest = new StringRequest(Request.Method.GET, u, new Response.Listener<String>() {
//                                        @Override
//                                        public void onResponse(String response) {
...
//                            popup.dismiss();
//
//                            Intent edit = new Intent(context, Highlight_Edit.class);
//                            edit.putExtra("post_id", list.get(i).getPost_Id());
//                            edit.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
//                            context.startActivity(edit);
//
//
...
//                            RequestQueue MyRequestQueue = Volley.newRequestQueue(context);
//
//                            String u = Config.BASE_URL + "Posts/Report_Post_Check";
//
//                            StringRequest MyStringRequest = new StringRequest(Request.Method.POST, u, new Response.Listener<String>() {
//                                @Override
//                                public void onResponse(String response) {
...
//                                                    RequestQueue MyRequestQueue = Volley.newRequestQueue(context);
//
//                                                    String u = Config.BASE_URL + "Posts/Report_Post";
//
//                                                    StringRequest MyStringRequest = new StringRequest(Request.Method.POST, u, new Response.Listener<String>() {
//                                                        @Override
//                                                        public void onResponse(String response) {
...
//                                                            Map<String, String> para = new HashMap<String, String>();
//
//                                                            para.put("Post_Id", list.get(i).getPost_Id());
//                                                            para.put("User_Id", login_user_id);
//                                                            para.put("Report_Type", rb.getText().toString());
//                                                            para.put("Report_Text", report_post_explain.getText().toString());
//
...
//
//                                                            para.put("User_Id", login_user_id);
//                                                            para.put("To_User_Id", list.get(i).getPost_User_Id());
//                                                            para.put("Report_Type", rb.getText().toString());
//                                                            para.put("Report_Text", report_user_explain.getText().toString());
//
//                                                            return para;
