...
public class PostCommentAdapter extends RecyclerView.Adapter<PostCommentAdapter.ViewHolder> {
    ...
    PostCommentAdapter a;

    public void setA(PostCommentAdapter a) {
        this.a = a;
    }

    public PostCommentAdapter(Context context, List<Comment_List> list, RecyclerView rv) {
        this.list = list;
    ...
    public PostCommentAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new PostCommentAdapter.ViewHolder(v);
    }

    @Override

    public void onBindViewHolder(@NonNull final PostCommentAdapter.ViewHolder holder, final int position) {
            ...
            public void onClick(View v) {
                        ...
                        comment_update.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                if (comment_edit_input.getText().toString().isEmpty()) {
                                    ...
                                    String u = Config.BASE_URL + "Trends/Trends_Comment_Update";
                    ...
                    public void onClick(View v) {
                        ...
                        yes.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                String u = Config.BASE_URL + "Trends/Trends_Comment_Delete/" + list.get(position).getComment_Id();
                ...
                reportpost.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        String u = Config.BASE_URL + "Trends/Report_TrendsComment_Check";
