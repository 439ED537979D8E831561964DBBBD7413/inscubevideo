...
import com.test.aashi.inscubenewbuild.YouTube;
...
public class HighlightPostAdapter extends RecyclerView.Adapter<HighlightPostAdapter.ViewHolder> {

    public List<Highlights_PostList> list = new ArrayList<>();
    ...
    public void setA(HighlightPostAdapter a)
    {
        this.a = a;
    }

    public HighlightPostAdapter(Context context, List<Highlights_PostList> list) {
        this.list = list;
    ...
    public void onBindViewHolder(@NonNull final ViewHolder holder, final int position)
    {
        ...
        {
            holder.shared.setText(" shared his own Post");
        }
        else
        {
            if (list.get(position).getOwnername().length() >12)
            {
                holder.shared.setText(" shared "+ list.get(position).getOwnername().substring(1,12)+"..." + "'s Post");
            }
            else
            {
                holder.shared.setText(" shared "+ list.get(position).getOwnername()+ "'s Post");
            }
        ...
        hello =new ArrayList<>();
        hello.addAll(list.get(position).getCube_Id());
        holder.post_type.setVisibility(View.VISIBLE);
        ...
        if (list.get(position).getFile_Name().size() != 0)

        {

         /*       holder.images.setVisibility(View.VISIBLE);
            holder.imageAdapter =new ImageAdapter(context,list.get(position).getFile_Name(), holder.images,
                    holder.imageAdapter, 1);
            holder.images.setAdapter(holder.imageAdapter);
         */
        ...
        if (list.get(position).getPost_Link().length() > 1) {
            if (list.get(position).getPostLink_Url().length() > 3) {
                if (list.get(position).getPostLink_Title().length() > 2) {
                    ...
                    holder.link_img.setOnClickListener(new View.OnClickListener() {
                        @Override
                        public void onClick(View v) {
                            String ItemName = String.valueOf(Html.fromHtml(list.get(position).getPostLink_Url()));

                            Intent intent = new Intent(context, YouTube.class);
                            intent.putExtra("webview", ItemName);
        ...
        if (list.get(position).getEmoteLists().size() != 0) {
            ...
            emoteGridAdapter = new EmoteGridAdapter(context, list.get(position).getEmoteLists(), holder.emote_view);
                    ...
                    public void onClick(View v) {
                        ...
                        yes.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                String u = Config.BASE_URL + "Posts/Cube_post_Delete/" + list.get(position).getPost_Id();
        ...
        holder.high_share.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v) {
                ...
                grid_elements=new ArrayList<>();
                                ...
                                reportuser_popup.showAtLocation(mView, Gravity.CENTER, 0, 0);
                                viewall=(TextView)mView.findViewById(R.id.viewa);
                ...
                emote_submit.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        if (emote_input.getText().toString().isEmpty()) {
                            ...
                            String u = Config.BASE_URL + "Posts/Emote_Submit";
                                        ...
                                        if (json.getString("Output").contains("True")) {
                                            ...
                                            try {
                                                ...
                                                new_emote.add(0, new EmoteList(resdata.getString("_id"),
                                                        ...
                                                        , resdata.getString("Count"), resdata.getString("Post_Id"), emote_user_ids));
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        TextView shared, Story_user_name, post_type, time_agotxt, view_all, post_text, any_link, link_des, link_url, link_title,arrays;
        ...
        public ViewHolder(View itemView) {
            ...
            arrays=(TextView)itemView.findViewById(R.id.arrays);
        ...
        public View getView(final int i, View view, ViewGroup viewGroup) {
            ...
            viewHolder.emote_layout.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    String u = Config.BASE_URL + "Posts/Emote_Update";
                    ...
                    StringRequest MyStringRequest = new StringRequest(Request.Method.POST, u, new Response.Listener<String>() {
                        ...
                        protected Map<String, String> getParams()
                        {
                            ...
                            para.put("Post_Id", emoteList.get(i).getEmote_post_Id());
                            para.put("User_Id", login_user_id);
...
//                    .placeholder(R.drawable.loading_spinner)
                    ...
                    try {
                        ...
                        if (result.contains("True"))
                        {
                            ...
                            for (int j = 0; j < res.length(); j++) {
                                ...
                                String datas= data.getString("_id");
                                hello1.addAll(Arrays.asList(datas));

                                Log.i("arraylist",hello1.toString());
    ...
    private class SharePost extends AsyncTask
    {
        ...
        protected Object doInBackground(Object[] objects)
        {
            ...
            String u = Config.BASE_URL + "Posts/Cube_Post_Share";
            ...
            StringRequest MyStringRequest = new StringRequest(Request.Method.POST, u, new Response.Listener<String>() {
                ...
                protected Map<String, String> getParams() {
                    Map<String, String> para = new HashMap<String, String>();
                    para.put("User_Id", login_user_id);
                    para.put("Cubes_List", cubeid.toString());
                    para.put("Post_Id",post_id );
                    return para;
                }
            };
            MyStringRequest.setRetryPolicy(new DefaultRetryPolicy(8000, 3, 2));
