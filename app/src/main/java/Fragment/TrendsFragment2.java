...
import com.test.aashi.inscubenewbuild.CubeCapturePost2;
...
public class TrendsFragment2 extends Fragment implements SwipeRefreshLayout.OnRefreshListener {

    RecyclerView highlight_posts;
    LinearLayout post_highlights,myvisible;
    TabLayout tabLayout;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState)
    {
        ...
        myvisible=getActivity().findViewById(R.id.linearLayout);
        ...
        SharedPreferences.Editor refresh = getActivity().getSharedPreferences("refresh", MODE_PRIVATE).edit();
        refresh.clear();
        refresh.commit();
        ...
        post_highlights.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent in = new Intent(getActivity(), TrendsPost2.class);
                startActivity(in);
    ...
    public void onResume() {
        ...
        refresh = getActivity().getSharedPreferences("refresh", MODE_PRIVATE);
    ...
    private class Get_post extends AsyncTask {
        ...
        protected Object doInBackground(Object[] objects) {
            ...
            String url = Config.BASE_URL + "Trends/Cube_Trends_List/" + login_user_Id+ "/0";

//            String url = Config.BASE_URL + "Trends/Cube_Trends_List/" + "5acc5d6e1295332c28f7e205/0";
                                    ...
                                    if (respon.length() != 0) {
                                        ...
                                        for (int i = 0; i < respon.length(); i++) {
                                          String trendTags = "";
                                            ...
                                            trendArray = data.optJSONArray("Trends_Tags");
                                    /*       if(trendArray != null)
                                          {
                                            ...
                                            */
                                            ...
                                            if (trendArray != null) {
                                                ...
                                                for (int j=0;j<len;j++){
                                                    Trends_text.add(trendArray.get(j).toString());
                                                }
                                            }
