...
public class CubeCapture_Comments extends AppCompatActivity {
    ...
    ArrayList<EmoteList> emoteLists,new_emote,emoteList;
    ...
    private class Get_Post extends AsyncTask {
        ...
        protected void onPreExecute() {
            ...
            pd = new ProgressDialog(CubeCapture_Comments.this);
        ...
        protected Object doInBackground(Object[] objects) {
            ...
            RequestQueue queue = Volley.newRequestQueue(CubeCapture_Comments.this);
...
//                                            Post_Category = data.getString("Post_Category");
                                            ...
                                            if (emote!=null && emote.length() != 0) {
                                                ...
                                                emoteGridAdapter=new EmoteGridAdapter(CubeCapture_Comments.this,
                                                        emoteLists,emote_view);
                                                emote_view.setAdapter(emoteGridAdapter);
                                            } else {
                ...
                public void onErrorResponse(VolleyError error) {
                    ...
                    Toast.makeText(CubeCapture_Comments.this, "Connection Error!..", Toast.LENGTH_SHORT).show();
                }
            });
    ...
    private void set_data() {
        ...
        if (Cube_name.size() != 0) {
            ...
            smallIcon_adapter = new FeedAdapterSmallIcon(CubeCapture_Comments.this, Cube_Id, Cube_Cat_Id, Cube_name, Cube_Image);
        ...
        if (File_Name.size() != 0) {
            ...
            multi_image_adapter = new Post_MultiImage_Adapter(CubeCapture_Comments.this, File_Name, multi_img_rv, multi_image_adapter, 1);
    ...
    private class Get_Comments extends AsyncTask {
        ...
        protected Object doInBackground(Object[] objects) {
            ...
            String url = Config.BASE_URL + "Capture/Capture_Comment_List/" + Post_Id;
            Log.i("Test", "doInBackground: " + url);
            // Request a string response from the provided URL.
            StringRequest stringRequest = new StringRequest(Request.Method.GET, url,
                    new Response.Listener<String>() {
                                ...
                                if (res.getString("Output").contains("True")) {
                                    ...
                                    if (respon.length() != 0) {
                                        ...
                                        for (int i = 0; i < respon.length(); i++) {
                                            ...
                                            Comment_Post_Id = data.getString("Capture_Id");
                                        ...
                                        comment_list_view.setVisibility(View.VISIBLE);
                                        highlightsCommentAdapter = new CaptureCommentAdapter(CubeCapture_Comments.this, comment_listList, comment_list_view);
    ...
    public class PostComment extends AsyncTask {
        ...
        protected Object doInBackground(Object[] objects) {
            ...
            String url = Config.BASE_URL + "Capture/Capture_Comment_Submit";
                ...
                public void onClick(View v) {
                    ...
                    StringRequest MyStringRequest = new StringRequest(Request.Method.POST, u, new Response.Listener<String>() {
                        ...
                        protected Map<String, String> getParams()
                        {
                            ...
                            para.put("Capture_Id", emoteList.get(i).getEmote_post_Id());
                            para.put("User_Id", login_user_id);
