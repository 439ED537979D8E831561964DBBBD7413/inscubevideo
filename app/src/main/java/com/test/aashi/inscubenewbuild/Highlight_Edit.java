...
public class Highlight_Edit extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_highlight__edit);
        ...
        recyclerView.setLayoutManager(new LinearLayoutManager(Highlight_Edit.this, LinearLayoutManager.HORIZONTAL, false));
        images_preview.setLayoutManager(new LinearLayoutManager(Highlight_Edit.this, LinearLayoutManager.HORIZONTAL, false));
...
//                dimBehind(link_popup);
        ...
        try {
            ...
            if (requestCode == 1000 && resultCode == RESULT_OK
                ...
                if (data.getData() != null) {
                    ...
                    selected_file.add(getPath(Highlight_Edit.this, mImageUri));
                    All_File.add(getPath(Highlight_Edit.this, mImageUri));
                    ...
                    if (data.getClipData() != null) {
                        ...
                        for (int i = 0; i < mClipData.getItemCount(); i++) {
                            ...
                            Uri uri = item.getUri();
                            mArrayUri.add(uri);
                            selected_file.add(getPath(Highlight_Edit.this, uri));
                            All_File.add(getPath(Highlight_Edit.this, uri));
                            // Get the cursor
                ...
                Uri selectedImage = getImageUri(Highlight_Edit.this, photo);
                ...
                selected_file.add(getPath(Highlight_Edit.this, selectedImage));
                All_File.add(getPath(Highlight_Edit.this, selectedImage));


            } else {
                Toast.makeText(Highlight_Edit.this, "You haven't picked Image",
            ...
            edit_image_adapter = new EditImageAdapter(Highlight_Edit.this, All_File, File_Status,
                    images_preview, edit_image_adapter, 0);
            ...
            Toast.makeText(Highlight_Edit.this, "Something went wrong", Toast.LENGTH_LONG).show();
        }
    ...
    private class Highlight_Post extends AsyncTask<Integer, Integer, String> {
        ...
        protected void onPostExecute(String s) {
            ...
            try {
                ...
                if (json.getString("Output").toString().contains("True")) {
                    ...
                    Intent in = new Intent(Highlight_Edit.this, StoryPage.class);
        ...
        protected String doInBackground(Integer... integers) {
            ...
            HttpPost httppost = new HttpPost(Config.BASE_URL + "Posts/Cube_Post_Update");
    ...
    private class GetCubelist extends AsyncTask {
        ...
        protected void onPreExecute() {
            ...
            pd = new ProgressDialog(Highlight_Edit.this);
        ...
        protected Object doInBackground(Object[] objects) {
            ...
            if (isNetworkConnected()) {
                ...
                RequestQueue queue = Volley.newRequestQueue(Highlight_Edit.this);
                            ...
                            public void onResponse(JSONObject response) {
                                try {
                                    ...
                                    if (Post_Cube_Id.length() != 0) {
                                        ...
                                        adapter = new FeedAdapterSmallIcon(Highlight_Edit.this, cube_list_data);
                ...
                Toast.makeText(Highlight_Edit.this, "Please check your internet connection", Toast.LENGTH_SHORT).show();
            }
            return null;
        }
    ...
    private class Get_Post extends AsyncTask {
        ...
        protected Object doInBackground(Object[] objects) {
            ...
            String url = Config.BASE_URL + "Posts/Cube_Post_View/" + login_user_id + "/" + Post_Id;
            ...
            StringRequest stringRequest = new StringRequest(Request.Method.GET, url,
                                ...
                                if (res.getString("Output").contains("True")) {
                                    ...
                                    if (respon.length() != 0) {
                                        ...
                                        for (int i = 0; i < respon.length(); i++) {
                                            ...
                                            files = data.getJSONArray("Attachments");
                ...
                public void onErrorResponse(VolleyError error) {
                    ...
                    Toast.makeText(Highlight_Edit.this, "Connection Error!..", Toast.LENGTH_SHORT).show();
                }
            });
    ...
    public class EditImageAdapter extends RecyclerView.Adapter<EditImageAdapter.ViewHolder> {
        ...
        public EditImageAdapter(Context context, ArrayList<String> img_name, ArrayList<String> img_status, RecyclerView rv,
                                EditImageAdapter adapter, int a) {
            super();
