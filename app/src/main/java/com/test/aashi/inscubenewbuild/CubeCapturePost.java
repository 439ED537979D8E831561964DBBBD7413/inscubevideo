...
public class CubeCapturePost extends AppCompatActivity {

    RecyclerView post_capture_list;
    PostCaptureMultiple PostCaptureMultiple;
    ArrayList<Category_GridList> grid_element = new ArrayList<>();

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_cube_capture_post);


        post_capture_list = (RecyclerView) findViewById(R.id.post_capture_list);

        post_capture_list.setLayoutManager(new LinearLayoutManager(
        ...
        PostCaptureMultiple = new PostCaptureMultiple(CubeCapturePost.this, grid_element);

        post_capture_list.setAdapter(PostCaptureMultiple);
