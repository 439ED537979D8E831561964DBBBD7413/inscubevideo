...
public class Highlights_Comments extends AppCompatActivity {
    ...
    HighlightsCommentAdapter highlightsCommentAdapter;
    TextView view_all;
   ...
   EmoteGridAdapter emoteGridAdapter;
    ...
    PopupWindow emote_popup,reportuser_popup;
    ImageView high_share;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        emoteLists =new ArrayList<EmoteList>();
        ...
        high_share =(ImageView)findViewById(R.id.high_share);
   ...
   /*      view_all.setOnClickListener(new View.OnClickListener() {
             ...
             public void onClick(View v) {
                 ...
                 emoteGridAdapter = new EmoteGridAdapter(Highlights_Comments.this, emoteLists, emote_view);
   ...
   high_share.setOnClickListener(new View.OnClickListener() {
       @Override
       public void onClick(View v) {
    ...
    private class Get_Post extends AsyncTask {
        ...
        protected void onPreExecute() {
            ...
            pd = new ProgressDialog(Highlights_Comments.this);
        ...
        protected Object doInBackground(Object[] objects) {
            ...
            RequestQueue queue = Volley.newRequestQueue(Highlights_Comments.this);
            ...
            StringRequest stringRequest = new StringRequest(Request.Method.GET, url,
                ...
                public void onErrorResponse(VolleyError error) {
                    ...
                    Toast.makeText(Highlights_Comments.this, "Connection Error!..", Toast.LENGTH_SHORT).show();
                }
            });
    ...
    private void set_data() {
        ...
        if (Cube_name.size() != 0) {
            ...
            smallIcon_adapter = new FeedAdapterSmallIcon(Highlights_Comments.this, Cube_Id, Cube_Cat_Id, Cube_name, Cube_Image);
        ...
        if (File_Name.size() != 0) {
            ...
            multi_image_adapter = new Post_MultiImage_Adapter(Highlights_Comments.this,
                    File_Name, multi_img_rv, multi_image_adapter, 1);
    ...
    private class Get_Comments extends AsyncTask {
        ...
        protected Object doInBackground(Object[] objects) {
            ...
            String url = Config.BASE_URL + "Posts/Comment_List/" + Post_Id;
                                ...
                                if (res.getString("Output").contains("True")) {
                                    ...
                                    if (respon.length() != 0) {
                                        ...
                                        for (int i = 0; i < respon.length(); i++) {
                                            ...
                                            Comment_Post_Id = data.getString("Post_Id");
                                            Comment_User_Image = Config.Images + "Users/" + data.getString("User_Image");
                                            Comment_Time = data.getString("Time_Ago");

                                            comment_listList.add(new Comment_List(Comment_User_Id,
                                                    Comment_User_Name, Comment_Text, Comment_Post_Id,
                                                    Comment_User_Image, Comment_Id, Comment_Time));

                                        }

                                        comment_list_view.setVisibility(View.VISIBLE);
                                        highlightsCommentAdapter = new HighlightsCommentAdapter(Highlights_Comments.this, comment_listList, comment_list_view);
    ...
    public class PostComment extends AsyncTask {
        ...
        protected void onPreExecute() {
            ...
            pd = new ProgressDialog(Highlights_Comments.this);
            pd.setMessage("Loading...");
            emote_view.setVisibility(View.GONE);
            pd.show();
        }
        ...
        protected Object doInBackground(Object[] objects) {
            ...
            String url = Config.BASE_URL + "Posts/Comment_Submit";
